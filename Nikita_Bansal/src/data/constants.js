...
export const experiences = [
  {
    ...
    desc: "Working on Open Source Projects",
    skills: [
      "Web Development",
      "C++ Programming",
      "DSA",
  ...
  },
  {
    ...
    desc: "As an Graphic designer at the Google Developers Student Club (GDCS), I have had the opportunity to work on exciting projects and collaborate with talented developers who share my passion for technology. Through my involvement with GDCS, I have also had the opportunity to host and participate in numerous events, including hackathons, study jams, and workshops.",
    skills: [
      "Leadership",
      "UI/UX",
      "Figma",
...
export const education = [
  {
    ...
    grade: "7 CGPA",
    desc: "I am currently pursuing a Bachelor's degree in Computer Science specialising in Artificial Intelligence and Data Science at Maharaja Agrasen Institute of Technology. I have completed 2 semesters and have a CGPA of 7. I am also a member of the Google Developers Student Club (GDSC) at MAIT, where I am learning and working on exciting projects with a team of talented developers.",
    degree: "Bachelor of Technology - BTech, Computer Science and Engineering Specialised in AI & DS",
  },
  {
    id: 1,
    school: "St. Mark's Girls Sr. Sec. School, Delhi",
    date: "Apr 2020 - Apr 2021",
    grade: "91%",
    desc: "I completed my class 12 high school education at St. Mark's Girls Sr. Sec. School, Delhi, where I studied Science with Computer Science.",
